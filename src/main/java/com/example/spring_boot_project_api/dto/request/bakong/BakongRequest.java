...
public record BakongRequest(
    ...
    public BakongRequest {
        ...
        merchantAlternateLanguagePreference =
                merchantAlternateLanguagePreference == null ? "km" : merchantAlternateLanguagePreference;
        merchantNameAlternateLanguage =
                merchantNameAlternateLanguage == null ? "អ្នកលក់" : merchantNameAlternateLanguage;
        merchantCityAlternateLanguage =
                merchantCityAlternateLanguage == null ? "ភ្នំពេញ" : merchantCityAlternateLanguage;
    }
}